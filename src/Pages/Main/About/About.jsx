...
const About = () => {
	...
	return (
		...
		>
			...
			<h2 className="lg:hidden font-extrabold text-center lg:text-start text-3xl xl:text-4xl heading mt-8">Akash Gupta</h2>
			...
			<div className="xl:hidden flex sm:flex-col sm:absolute right-0 top-56 justify-center my-5 lg:my-10 gap-5 text-2xl">
				<RouterLink
					...
					target="_blank"
					to="https://www.linkedin.com/in/skygupta0/"
				...
				<RouterLink
					...
					to="https://www.instagram.com/akash.gupta/"
					target="_blank"
			...
			<div className="text-sm sm:text-base lg:w-2/3 xl:w-1/2">
				<h2 className="hidden lg:block font-extrabold text-3xl xl:text-4xl heading">Akash Gupta</h2>
				...
				<RouterLink
					tabIndex={5}
					to="https://firebasestorage.googleapis.com/v0/b/akashs-portfolio.appspot.com/o/Akash%20Rajesh%20Gupta.pdf?alt=media&token=361168f2-05eb-4039-91b6-b827c27c7457" target="_blank"
